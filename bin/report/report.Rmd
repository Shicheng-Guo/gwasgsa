...
This report is generated from [GWAS-GSA pipeline](https://github.com/lifebit-ai/gwasgsa/) which uses [MAGMA tool](https://ctg.cncr.nl/software/magma) to do gene-set analysis on GWAS data.
